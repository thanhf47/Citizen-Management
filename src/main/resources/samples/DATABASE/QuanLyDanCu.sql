...
CREATE TABLE KHAITU(
	...
	MANHANKHAUNGUOICHET INT NOT NULL UNIQUE,
	NGAYKHAI DATE,
	NGAYCHET DATE,
...
@MAHOKHAU INT, @MAKHOANTHU INT, @SOTIENCANDONG BIGINT, @TRANGTHAI BIT
AS
BEGIN
	INSERT INTO DONGGOP(MAHOKHAU, MAKHOANTHU, SOTIENCANDONG, TRANGTHAI)
	VALUES(@MAHOKHAU, @MAKHOANTHU, @SOTIENCANDONG, @TRANGTHAI);

	DECLARE @TENCHUHO NVARCHAR(300), @DIACHI NVARCHAR(300), @SOTHANHVIEN INT
	...
	UPDATE DONGGOP
	SET TENCHUHO = @TENCHUHO, DIACHI = @DIACHI, SOTHANHVIEN = @SOTHANHVIEN
	WHERE MAKHOANTHU = @MAKHOANTHU AND MAHOKHAU = @MAHOKHAU;
END;


EXEC INSERT_DONGGOP 1,1,240000, 0
EXEC INSERT_DONGGOP 2,1,240000, 0
EXEC INSERT_DONGGOP 3, 1, 240000, 0
EXEC INSERT_DONGGOP 1, 2, 100000, 0
EXEC INSERT_DONGGOP 2, 2, 100000, 0
EXEC INSERT_DONGGOP 3, 2, 100000, 0
EXEC INSERT_DONGGOP 1, 3, 0, 0
EXEC INSERT_DONGGOP 2, 3, 0, 0
EXEC INSERT_DONGGOP 3, 3, 0, 0


UPDATE DONGGOP
SET TRANGTHAI = 1,
	NGAYDONG = '2023-12-1',
	SOTIENDADONG = SOTIENCANDONG
