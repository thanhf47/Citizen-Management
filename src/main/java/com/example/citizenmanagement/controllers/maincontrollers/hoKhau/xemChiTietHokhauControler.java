    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        xac_nhan_but.setOnAction(event -> {
            ...
            if(thaydoi_but.isVisible()) {
                ...
                int ketqua = 0;
                ketqua = Model.getInstance().getDataBCHK().capNhatHoKhau(ma_ho_khau.getText(), ma_chu_ho.getText(), dia_chi.getText(), ghi_chu.getText());
                if (ketqua != 0) {
                ...
                int ketqua = Model.getInstance().getDataBCHK().xoa_ho_khau(ma_ho_khau.getText());
                if(ketqua!=0) {
                    thong_bao_loi_lbl.setStyle("-fx-text-fill: #10e61c");
