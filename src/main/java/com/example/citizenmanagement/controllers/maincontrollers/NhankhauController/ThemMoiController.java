...
public class ThemMoiController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        confirm_btn.setOnAction(actionEvent -> {
           ...
           int thanhcong = Model.getInstance().getDatabaseConnectionNhanKhau().addNhanKhau(ho_ten_text.getText(),cccd_text.getText(), nam_sinh_text.getText(), bit, noi_sinh_text.getText(), nguyen_quan_text.getText(), dan_toc_text.getText(), ton_giao_text.getText(), quoc_tich_text.getText(), so_ho_chieu_text.getText(), thuong_tru_text.getText(), nghe_text.getText(), ngay_tao_text.getText(), ghi_chu_text.getText());
        if(thanhcong == 0) {
