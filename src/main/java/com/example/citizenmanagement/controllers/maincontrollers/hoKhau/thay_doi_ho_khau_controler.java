                ...
                try {
                    if(resultSet.isBeforeFirst()) {
                        while(resultSet.next()) {
                            ...
                            listView_nhan_khau.getItems().add(new List_nhan_khau(ma_nhan_khau,cccd, hoTen, gioitinh, namsinh, diachi));
                        }
        ...
        try{
            if(resultSet.isBeforeFirst()){
                while (resultSet.next()) {
                    ...
                    listView_nhan_khau.getItems().add(new List_nhan_khau(ma_nhan_khau,id, hoten, gioitinh, namsinh, thuongtru));
                }
            }
        }
        catch(Exception e) {
