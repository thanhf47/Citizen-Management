...
public class thay_doi_ho_khau_controler implements Initializable {
    ...
    private thanh_vien_cua_ho_cell thanh_vien_cua_ho_dc_chon=null;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        listView_thanh_vien.setOnMouseClicked(mouseEvent -> {
            thanh_vien_cua_ho_dc_chon = listView_thanh_vien.getSelectionModel().getSelectedItem();
        });
        ...
        xoa_thanh_vien_but.setOnAction(actionEvent -> {
            if(thanh_vien_cua_ho_dc_chon!=null){
                if(!thanh_vien_cua_ho_dc_chon.getCccd().equals(tam.getOwner().get())) {
                    Model.getInstance().getDatabaseConnection().xoa_thanh_vien_cua_ho(thanh_vien_cua_ho_dc_chon.getCccd());
                    listView_nhan_khau.getItems().clear();
                    listView_thanh_vien.getItems().clear();
                    cap_nhat_list_view_nhan_khau();
                    cap_nhat_list_view_thanh_vien();
            ...
            thanh_vien_cua_ho_dc_chon=null;
        });
        ...
        huy_but.setOnAction(actionEvent -> {
            ...
            if(resutl==ButtonType.OK) {
                ObservableList<thanh_vien_cua_ho_cell> danh_sach_thanh_vien_cua_ho_hien_tai = FXCollections.observableArrayList();
                danh_sach_thanh_vien_cua_ho_hien_tai = listView_thanh_vien.getItems();
        ...
        xac_nhan_but.setOnAction(actionEvent -> {
            ...
            if(resutl==ButtonType.OK) {
                ...
                if(ketqua==1) {
                    ...
                    Alert alert1 = new Alert(Alert.AlertType.INFORMATION);
                    alert1.setContentText("Ban da khong thay doi thanh cong!");
                    alert1.setHeaderText(null);
                    alert1.showAndWait();
                }
            }
                ...
                if(resultSet.isBeforeFirst()){
                    while (resultSet.next()){
                        ...
                        if(resultSet1.isBeforeFirst()){
                            ...
                            listView_thanh_vien.getItems().add(new thanh_vien_cua_ho_cell(cccd, hoTen, quanHe,ngaySinh,gioiTinh));
